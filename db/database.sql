...
CREATE TABLE NORMAL_FAVOURITES (
  Favourite_id INT references TWEET(Tweet_id),
  User_id INT references USER1(User_id)
);

DROP TABLE IF EXISTS NORMAL_RETWEETS CASCADE;
CREATE TABLE NORMAL_RETWEETS (
  Retweet_id INT references TWEET(Tweet_id),
  User_id INT references USER1(User_id)
);
...
INSERT INTO tweet VALUES (1, '2015-11-26 00:01:00', 0, 0, 'ITS ALIVE!');
INSERT INTO tweet VALUES (2, '2015-11-26 00:02:00', 0, 0, 'I cannoli be happy when Im with you. <3');
INSERT INTO tweet VALUES (3, '2015-11-26 00:03:00', 0, 0, 'How many tickles does it take to make a squid laugh? Ten-tickles!');
INSERT INTO tweet VALUES (4, '2015-11-26 00:04:00', 0, 0, 'He made me do it!');
INSERT INTO tweet VALUES (5, '2015-11-26 00:05:00', 0, 0, 'Hi world!');
INSERT INTO tweet VALUES (6, '2015-11-26 00:06:00', 0, 0, 'Words cannot espresso what you mean to me. <3');

insert into normal_tweets values (1, 4);
insert into normal_tweets values (2, 4);
insert into normal_tweets values (3, 5);
insert into normal_tweets values (4, 5);
insert into normal_tweets values (5, 6);
insert into normal_tweets values (6, 6);
